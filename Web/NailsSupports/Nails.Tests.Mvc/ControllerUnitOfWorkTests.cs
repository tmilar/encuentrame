...
{
    [TestFixture]
    public class ControllerUnitOfWorkTests : BaseTest
    {
        [Test]
        public void ActionsShouldBeRanWithinUnitOfWorks()
        {
            Nails.Configure()
                ...
                .InspectAssemblyOf<TestController>()
            ...
            var controller = TestControllers.Get<TestController>();

            controller.Index();
            Assert.IsTrue((bool) controller.ViewData["UnitOfWork"]);
        }
    }
}