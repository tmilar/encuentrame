(function () {
    $.validator.addMethod('greaterthanotherproperty',
    ...
    $.validator.unobtrusive.adapters.add('greaterthanotherproperty', ['otherproperty'], function (options) {
        var parameters = {
            otherproperty: options.params['otherproperty']
        };

        options.rules['greaterthanotherproperty'] = parameters;
       
        options.messages['greaterthanotherproperty'] = options.message;
    });
